...
function CostoDrillPanel({
  ...
  // G&A categories — definidas al nivel del componente para que scope sea siempre el estado actual
  const gaCats = [{
    k: 'adm',
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, ((det.totals.mp.mes + det.totals.mo.mes + det.totals.cf.mes) * 1000 / 7058).toFixed(0), " USD/ton"), "\xB7 vs Ppto 811 USD/ton \xB7 El menor costo unitario diluye el costo fijo gracias al volumen sobreejecutado."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, fmt(gaGrandReal)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      fontFamily: 'DM Mono',
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
    ...
    }, fmt(catRef)), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '11px 14px',
        textAlign: 'right',
        fontFamily: 'DM Mono',
      ...
      }, ppto !== 0 ? fmt(ppto) : '—'), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: '8px 14px',
          textAlign: 'right',
          fontFamily: 'DM Mono',
      ...
      }, isNeg ? '—' : (vi.abs >= 0 ? '+' : '') + fmt(vi.abs).replace('+', '')), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: '8px 14px',
          textAlign: 'right',
          fontFamily: 'DM Mono',
      ...
      }, fmt(it.mesAnt)), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: '8px 14px',
          textAlign: 'right',
          fontFamily: 'DM Mono',
      ...
      }, ref !== 0 ? fmt(ref) : '—'), /*#__PURE__*/React.createElement("td", {
        style: {
          padding: '8px 14px',
          textAlign: 'right',
          fontFamily: 'DM Mono',
